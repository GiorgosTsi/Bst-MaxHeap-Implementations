...
public class Main1 {
    public static void main(String []args){
        ...
        BST binarySearchTree = new BinarySearchTreeWithPointers();
        ...
        /*Test get minimum key method: */
        BinarySearchTreeWithPointers bst = (BinarySearchTreeWithPointers)binarySearchTree;
        System.out.println(bst.getMinimumKey());
